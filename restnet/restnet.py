...
if __name__ == '__main__':
    try:
        ...
        food_resnet.evaluate_model(filename='metrics.json')
        food_resnet.checking(file_path=r'C:\Users\asrabanu\PycharmProjects\PythonProject\Food Classification Dataset\dataset\training\burger\134.jpg')
