...
if __name__ == "__main__":
    try:
        train_dir = r'C:\Users\asrabanu\PycharmProjects\PythonProject\Food Classification Dataset\dataset\training'
        test_dir = r'C:\Users\asrabanu\PycharmProjects\PythonProject\Food Classification Dataset\dataset\testing'
        val_dir = r'C:\Users\asrabanu\PycharmProjects\PythonProject\Food Classification Dataset\dataset\validation'
        food_cnn = CNN(train_dir, test_dir, val_dir)
        food_cnn.architecture()
        food_cnn.metrics()
        food_cnn.evaluate(filename='metrics.json')
        food_cnn.checking(file_path=r'C:\Users\asrabanu\PycharmProjects\PythonProject\Food Classification Dataset\dataset\validation\Donut\Donut (10).jpeg')
