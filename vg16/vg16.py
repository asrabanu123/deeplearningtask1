...
class FoodVGG16:
    ...
    def train_model(self, epochs):
        try:
            ...
            self.model.save('vgg16_model.h5')
...
if __name__ == '__main__':
    try:
        ...
        food_vgg16 = FoodVGG16(train_path, val_path, test_path)
        food_vgg16.build_vgg16()
        food_vgg16.train_model(epochs=30)
        food_vgg16.evaluate_model(filename='metrics.json')
        food_vgg16.checking(file_path=r'C:\Users\asrabanu\PycharmProjects\PythonProject\Food Classification Dataset\dataset\training\burger\10.jpg')
